...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = { /* 0: base */
    ...
    {TAB_FN1,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      __NO___,    KC_ENT},
    {KC_LSFT,   __NO___, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,   KC_DOT,     KC_SLSH},
    {__NO___,  KC_LCTL,  __NO___, KC_LALT, KC_LGUI, _SPACE_,  __NO___,  MO(1),    MO(2),    KC_PAUS,   KC_RSFT}
  },
  /* 1: numbers and arrows */
  [1] = { 
    {_______,   KC_1,    KC_2,    KC_3,    KC_4,    _______,  _______,  _______,  KC_UP,    _______,   SCRNCAP,    KC_DEL},
    {KC_CAPS,   KC_5,    KC_6,    KC_7,    KC_8,    _______,  M(1),     KC_LEFT,  KC_DOWN,  KC_RIGHT,  __NO___,    KC_QUOT},
  ...
  [2] = { 
    ...
    {_______,   KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______,  _______,  KC_LCBR,  KC_RCBR,  KC_MINS,   __NO___,    KC_UNDS},
    {_______,   __NO___, KC_LPRN, KC_RPRN, KC_UNDS, KC_PLUS,  _______,  _______,  KC_LPRN,  KC_RPRN,   _______,    _______},
    {__NO___,   _______, __NO___, _______, _______, _______,  __NO___,  _______,  _______,   _______,  _______}
  }
};
