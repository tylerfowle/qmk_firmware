...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = { /* 0: base */
    ...
    {TAB_FN1,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,     KC_H,     KC_J,     KC_K,     KC_L,      XXXXXXX,    KC_ENTER},
    {KC_LSFT,   XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,   KC_DOT,     KC_SLSH},
    {XXXXXXX,   KC_LCTL, XXXXXXX, KC_LALT, KC_LGUI, SPC_FN3,    XXXXXXX,  MO(1),    MO(2),    KC_BSLS,   KC_QUOT}
  },
  /* 1: numbers and arrows */
  [1] = { 
    {KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    _______,  _______,  _______,  KC_UP,    _______,   SCRNCAP,    KC_DEL},
    {_______,   KC_5,    KC_6,    KC_7,    KC_8,    _______,  M(1),     KC_LEFT,  KC_DOWN,  KC_RIGHT,  XXXXXXX,    KC_SCLN},
    {_______,   XXXXXXX, KC_9,    KC_0,    KC_MINS, KC_EQUAL, COLORCAP, _______,  _______,  KC_VOLD,   KC_VOLU,    KC_MUTE},
  ...
  [3] = { 
    {_______,   _______, _______, _______, _______, _______,  _______,  _______,  _______,  _______,   _______,    _______},
    {_______,   _______, _______, _______, _______, _______,  _______,  _______,  _______,  _______,   XXXXXXX,    S(KC_SCLN)},
    {_______,   XXXXXXX, _______, _______, _______, _______,  _______,  _______,  _______,  _______,   _______,    _______},
    {XXXXXXX,   _______, XXXXXXX, _______, _______, _______,  XXXXXXX,  _______,  _______,   _______,  _______}
  }
};
