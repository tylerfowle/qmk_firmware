...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = {
    ...
    {TG(1),   KC_LCTL, KC_LALT, KC_LGUI, MO(3),   _SPACE_, __NO___, MO(2),   _______, KC_QUOT,  KC_BSLS, _______}
  },
  ...
  [4] = {
    ...
    {_______, _______, _______, _______, _______, _SPACE_, __NO___, KC_MPRV, KC_MNXT, KC_MPLY,  _______,   _______}
  }
};
