...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = {  /* Base */
    ...
    {__NO___, KC_LCTL, KC_LALT, KC_LGUI, MO(1),   _SPACE_, __NO___, MO(2),   __NO___, __NO___,  __NO___, KC_PENT}
  },
  [1] = { /* FN1 // Left FN */
    {KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  _______, _______, _______, KC_UP,   _______,  SCRNCAP, KC_DELETE},
    {_______, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______, M(1),    KC_LEFT, KC_DOWN, KC_RIGHT, KC_BSLS, KC_QUOT},
