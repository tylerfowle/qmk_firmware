...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MAC] = {
    ...
    { KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, MO(_SYM),_SPACE_, KC_LEFT, KC_DOWN, KC_RIGHT, _SPACE_, MO(_NUM),MO(_EXT),KC_BSLS, KC_LEAD, TG(_MOUSE) },
  },
  ...
  [_NUM] = {
    ...
    { _______, KC_5,    KC_6,    KC_7,    KC_8,    _______, KC_P4,   KC_P5,   KC_P6,   _______, KC_QUOT, KC_DQUO, KC_GRV,  _______, _______ },
  ...
  [_SYM] = {
    ...
    { _______, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, _______, KC_P4,   KC_P5,   KC_P6,   _______, KC_LCBR, KC_RCBR, KC_MINS, KC_UNDS, _______ },
