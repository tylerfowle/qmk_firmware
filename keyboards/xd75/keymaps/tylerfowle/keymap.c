...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* 0 */
  [_MAC] = {
    { M(0),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC },
    ...
    { KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, MO(_SYM),HYPRSPC, _______, _______, _______, _SPACE_, MO(_NUM),MO(_EXT),KC_BSLS, KC_LEAD, TG(_MOUSE) },
  },
  ...
  [_SYM] = {
    ...
    { _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______ },
