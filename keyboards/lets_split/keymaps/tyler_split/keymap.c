...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = KEYMAP( \
    ...
    DF(3),   _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______
  ),
  ...
  [3] = KEYMAP( \
    ...
    DF(4),   _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,  _______
  ),
  ...
  [4] = KEYMAP( \
    ...
    DF(5),   _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY,  _______,   RESET
  ),
